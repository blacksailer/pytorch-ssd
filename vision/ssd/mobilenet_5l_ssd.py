...
def create_mobilenetv1_ssd(num_classes, is_test=False):
    ...
    regression_headers = ModuleList([
        ...
        Conv2d(in_channels=512, out_channels=6 * 4, kernel_size=3, padding=1), # TODO: change to kernel_size=1, padding=0?
    ])
    ...
    classification_headers = ModuleList([
        ...
        Conv2d(in_channels=512, out_channels=6 * num_classes, kernel_size=3, padding=1), # TODO: change to kernel_size=1, padding=0?
    ])
